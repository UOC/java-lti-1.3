...
import edu.uoc.elc.lti.platform.deeplinking.content.LinkItem;
import edu.uoc.elc.lti.platform.deeplinking.content.LtiResourceItem;
...
public class DeepLinkingClientTest {
	...
	public void perform() throws IOException {
		...
		this.sut = new DeepLinkingClient("https://www.uoc.edu",
